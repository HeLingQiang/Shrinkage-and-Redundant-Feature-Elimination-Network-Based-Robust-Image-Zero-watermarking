...
def main():
    ...
    new_run_parser.add_argument('--batch-size', '-b', default=16, type=int, help='The batch size.')
    ...
    if args.command == 'continue':
        ...
        hidden_config = HiDDenConfiguration(H=args.size, W=args.size,
                                            ...
                                            encoder_blocks=4, encoder_channels=30,
                                            decoder_blocks=7, decoder_channels=30,
                                            use_discriminator=False,
                                            use_vgg=False,
                                            discriminator_blocks=3, discriminator_channels=30,
                                            decoder_loss=1,
                                            encoder_loss=0,
                                            adversarial_loss=0,#1e-3
    ...
    noiser = Noiser(noise_config, device,if_random=True)
